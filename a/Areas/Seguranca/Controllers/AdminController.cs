...
namespace a.Areas.Seguranca.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult Edit(string id)
        {
            ...
            Usuarios usuario = GerenciadorUsuario.FindById(id);
            if (usuario == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Edit(UsuarioViewModel uvm)
        {
            if (ModelState.IsValid)
            {
                Usuarios usuario = GerenciadorUsuario.FindById(uvm.Id);
        ...
        {
            Usuarios user = GerenciadorUsuario.FindById(usuario.Id);
            if (user != null)
            {
